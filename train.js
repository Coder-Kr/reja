...
class Shop {
    ...
    qoldiq() {
        return `Hozir ${this.vaqt} da ${this.non}ta non, ${this.lagmon}ta lagmon va ${this.cola}ta cola mavjud`;
    };
    sotish(name, number) {
        if (name == 'non') {
            this.non = this.non - number;
        } else if (name == 'lagmon') {
            this.lagmon = this.lagmon - number;
        } else if (name == 'cola') {
            this.cola = this.cola - number;
        } else {
            console.log(`Bunday tovaqr mavjud emas!`);
        }
    };
    qabul(name, number) {
        if (name == 'non') {
            ...
            console.log("Bunday tovar mavjud emas!");
        }
    };
};
